...
export const FormPage = () => {
  ...
  const content = `I joined @webthreetester waitlist. 🥳 Excited to start my passive income journey by testing the web3 products.  
  
  Join me here: https://www.web3tester.xyz`;
